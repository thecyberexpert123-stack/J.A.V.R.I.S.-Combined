...
### B-C3 · Doorway survival: `sd_notify` watchdog + `STATUS=` + per-unit hardening — *OWNER-Q* (S–M) — `[x]` **done 2026-09-06** (ADR-0029 accepted D7/D8; implemented; ships in 1.21.0)
...
§E outcomes: **C6** all seven ✔ (2026-09-06) · **C11** all seven ✔ (2026-09-06) · **C3** all seven ✔ (2026-09-06; absent-precondition path = no `NOTIFY_SOCKET` → inert, tested; interfaces additive: unit text gained lines, `service_content`/`install_timer` gained keyword-only parameters, `build_server` gained an optional 4th argument).
