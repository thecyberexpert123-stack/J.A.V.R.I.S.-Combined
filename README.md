...
| --- | --- | --- | --- |
| [`JARVIS-MAIN/J.A.V.R.I.S.-arena-01a06229-j-a-v-r-i-s/`](JARVIS-MAIN/J.A.V.R.I.S.-arena-01a06229-j-a-v-r-i-s/) | `jarvis-agent` (`jarvis`) | The **kernel**: a Linux automation agent with a safety kernel, tiered consent, an audit journal, undo, a cited knowledge base and an MCP surface. Zero runtime dependencies. | 1.22.0 |
